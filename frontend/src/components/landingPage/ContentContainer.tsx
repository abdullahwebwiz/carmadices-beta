        ...
        <div className="flex flex-col gap-8 w-full">
          ...
          <div className="bg-dark-blue flex lg:px-20 py-8 flex-col gap-8 px-8">
            ...
            <div className="flex flex-1 flex-col justify-center items-center text-white text-center">
              ...
              <h2 className="font-bold text-2xl text-blue">Value, Safety and Appearance</h2>
              <p className="text-lg lg:text-center mb-2 mt-4 w-full lg:w-2/3">Restores clarity to headlights that have become foggy, discolored, or yellowed due to sun damage and continuous exposure to environmental factors. This service typically takes less than an hour to complete.</p>
              <div className="flex gap-4 mt-2 flex-wrap">
              <a href="tel:+19547663631" className="border-2 border-blue py-2 px-6 rounded-full flex-1 flex-initial w-auto">Call Now</a>
              <a href="https://wa.me/+17542718031" className="border-2 border-blue py-2 px-6 rounded-full flex-1 flex-initial w-auto">WhatsApp</a>
